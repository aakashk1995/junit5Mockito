...
//look for main application class in spring and it will use to start springboot project
//It will create beans with all 3 layers controller, service, database layer and run spring boot test application on
//random port
...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) //It will create only 1 object of class for all @Test Methods so that all instance variable
//data can be shared among different Test methods
public class UserControllerIntegrationTest {
    ...
    //this method will create actual http rest and test all layers.
    @Test
    ...
    void testCreateUser_whenValidDetailsProvided_returnsUserDetails() throws JSONException {
        ...
        // Act
        ResponseEntity<UserRest> createdUserDetailsEntity = testRestTemplate.postForEntity("/users/createUser",
                request,
                UserRest.class);
    ...
    void testGetUsers_whenMissingJWT_returns403() {
        ...
        // Act
        ResponseEntity<List<UserRest>> response = testRestTemplate.exchange("/users/getAllUsers",
                HttpMethod.GET,
                requestEntity,
